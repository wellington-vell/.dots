{
  flake.modules.nixos.neovim =
    ...
    let
      ...
      lazyvimIcon = ../../../assets/lazyvim.svg;
    ...
    in
    {
      ...
      # LazyVim config from the store. Plugins install to ~/.local/share/nvim,
      # and lazy.nvim writes lazy-lock.json / lazyvim.json at the config root, so
      # ~/.config/nvim stays a real writable dir with read-only entries linked in.
